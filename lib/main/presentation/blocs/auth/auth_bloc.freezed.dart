...
abstract class $AuthStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({AuthStatus status, String token, String errorMessage, User? user});
...
class _$InitialImpl implements _Initial {
  ...
  @override
  String toString() {
    return 'AuthState(status: $status, token: $token, errorMessage: $errorMessage, user: $user)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, status, token, errorMessage, user);
